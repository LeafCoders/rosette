...
public class CreateGroupWithWrongPasswordTest extends AbstractIntegrationTest {
	...
	public void test() throws ClientProtocolException, IOException {
		...
		postRequest.addHeader(new BasicScheme().authenticate(new UsernamePasswordCredentials("lars.arvidsson@gmail.com", "adsf"), postRequest));

package se.ryttargardskyrkan.rosette.integration.userresourcetype.create
...
public class CreateUserResourceTypeTest extends AbstractIntegrationTest {
    ...
    public void test() throws ClientProtocolException, IOException {
        ...
        // When
        HttpPost postRequest = new HttpPost(baseUrl + "/userResourceTypes")
        String requestBody = """
		{
			"name" : "motesledare",
			"groupId" : "1"
        ...
        UserResourceType responseUserResourceType = new ObjectMapper().readValue(responseJson, new TypeReference<UserResourceType>() {})

        TestUtil.assertJsonEquals("""
		{
			"id" : "${responseUserResourceType.getId()}",
			"name" : "motesledare",
			"groupId" : "1",
			"sortOrder" : 0
		}
        ...
        assertEquals(1L, mongoTemplate.count(new Query(), UserResourceType.class))
        TestUtil.assertJsonEquals("""
		[{
			"id" : "${responseUserResourceType.getId()}",
			"name" : "motesledare",
